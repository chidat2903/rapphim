...
<div class="contaniner" style="background:rgba(109, 109, 109, 0.689)">
    ...
    <div class="container contents">
        <div class="content-title">
            <div class="content-title-big d-flex mx-auto">
                <button type="button" class="btn btn-danger btn-lg">TIN TỨC - KHUYẾN MÃI</button>
            </div>
        </div>
        <div class="row px-2 d-flex">
            <div class="col-md-3 card mx-2 custom-shadow">
          ...
          <div class="row text-center">
            <a href="#" class="text-danger text-decoration: none">Xem thêm</a>
          </div>
    </div>
    ...
    <div class="container contents">
        <div class="content-title">
            <div class="content-title-big d-flex mx-auto">
                <button type="button" class="btn btn-danger btn-lg">BÌNH LUẬN NỔI BẬT</button>
            </div>
        </div>
